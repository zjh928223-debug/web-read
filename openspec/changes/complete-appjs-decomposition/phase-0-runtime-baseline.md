...
| `forceUpdateUI` | `src/composables/playback-module.js`, re-exported by `app.js` | Vue transcript/chunk components, verification scripts, import/session modules | playback module API injected into components/modules | Vue components stop using `window.forceUpdateUI` |
