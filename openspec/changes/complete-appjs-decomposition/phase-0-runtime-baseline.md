...
| `forceUpdateUI` | `src/composables/playback-module.js`, re-exported by `app.js` | `transcript-interactions.js`, `ChunkModeView.vue`, verification scripts, import/session modules | playback module API injected into components/modules | Vue components stop using `window.forceUpdateUI` |
...
| `notifyAnnotationBubbleWordClick` | `app.js`, injected into `src/composables/transcript-interactions.js` for normal transcript clicks | `transcript-interactions.js`, `ChunkModeView.vue`, interaction verification | annotation bubble/click resolver module | components no longer call `window.notifyAnnotationBubbleWordClick` |
...
| --- | --- | --- | --- |
| `chunk-note-layout-helpers.js` | `global.ChunkNoteLayoutHelpers` | `app.js`, `src/composables/chunk-note-layout.js` | `src/utils/` or `src/composables/chunk-note-layout.js` ES module |
