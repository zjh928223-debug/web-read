...
- [x] 4.10 Run `npm test`, `npm run verify:playback`, and `npm run verify:interactions`.
...
- [x] 6.3 Audit consumers of `annotation-bubble.js` and migrate it into the Vite module graph if no regular script semantics remain necessary.
