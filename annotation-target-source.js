(function (global) {
    ...
    function buildTargetSource(context = {}) {
    ...
    function getTargetsForSentence(targetSource, sentenceIndex, sentenceId) {
    ...
    function countTargetsFromContext(context = {}) {
        return buildTargetSource(context).targets.length;
    }

    function extractRawMarkupTargets(blockContext, sentenceIndex, sentenceId) {
    ...
    function extractMarkedTargets(blockContext, sentenceIndex, sentenceId, marksByIndex) {
    ...
    global.AnnotationTargetSource = {
        buildTargetSource,
        getTargetsForSentence,
        countTargetsFromContext,
        extractRawMarkupTargets,
        extractMarkedTargets
    };
})(window);
