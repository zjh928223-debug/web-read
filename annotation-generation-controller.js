(function (global) {
    ...
    const STORAGE = global.AnnotationGenerationStorage;
    const BLOCK_PLANNER = global.AnnotationBlockPlanner;
    const PROMPT_BUILDER = global.AnnotationPromptBuilder;
    const API_CLIENT = global.AnnotationApiClient;
    const DIFF_HELPER = global.AnnotationGenerationDiff;
    const DIAGNOSTICS = global.AnnotationGenerationDiagnostics;
    const DIAGNOSTIC_RECORDS = global.AnnotationGenerationDiagnosticsRecords;
    const RUN_DIAGNOSTICS = global.AnnotationRunDiagnostics;
    ...
    async function startFullArticle(context = {}, callbacks = {}) {
    ...
    global.AnnotationGenerationController = {
        startFullArticle,
        requestStop,
        getActiveRunInfo,
        getConfigState,
