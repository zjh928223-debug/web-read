(() => {
    function findChunkIndexByTime(chunkItems, time) {
    ...
    function bsFindActive(wordStarts, words, time) {
    ...
    function getCurrentSegmentIndex(segments, words, wordStarts, time) {
    ...
    function getSegmentCheckpoints(segments, segIndex) {
