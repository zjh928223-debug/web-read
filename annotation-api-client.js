(function (global) {
    ...
    async function generateAnnotations(promptPayload, options = {}) {
    ...
    function isRetryableFailureType(failureType) {
    ...
    function compactMemoryHint(value) {
