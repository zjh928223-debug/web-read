...
assert.ok(appSource.includes("import { initReaderRuntimeAssembly } from './reader-runtime-assembly.js';"), 'reader-runtime should delegate bridge startup through reader-runtime-assembly');
