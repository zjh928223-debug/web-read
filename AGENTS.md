...
`src/main.js` also imports the 11 `src/utils/*.js` modules and 14 `src/services/annotation/*.js` modules for side effects and ES module exports.
...
- `app.js` - about 1814 lines. High risk. Remaining central state, playback wiring, compatibility facades, and legacy exports.
