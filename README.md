...
├── composables/               # 13 moduleized legacy behavior chunks
...
- `app.js` still owns remaining central runtime state and compatibility facades, but transcript and chunk state now go through focused adapters.
