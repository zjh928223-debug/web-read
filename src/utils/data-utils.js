...
export function normalizeLooseKey(key) {
  return String(key || '').replace(/\uFEFF/g, '').trim().toLowerCase();
}

export function getLooseProp(obj, names) {
...
export function looksLikeSegmentArray(arr) {
...
export function validateTranscriptData(json, segmentsFallback) {
...
export function validateVisualData(input) {
...
export function validateChunkData(input) {
...
export function validateMarksArray(input, maxWordLen) {
