  ...
  function init(deps) {
    ...
    var setMarkKey = deps.setMarkKey;
    ...
    var hotkeyInputs = [hotkeyInput, hotkeyAnnotationBubbleInput, hotkeyBackwardInput, hotkeyForwardInput, hotkeyChunkCnInput, hotkeyChunkShadowInput].filter(function (el) { return !!el; });
