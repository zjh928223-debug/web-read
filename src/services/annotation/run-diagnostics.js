...
export function createRun(scope = {}, meta = {}) {
    ...
    record(global, normalizedScope, runId, 'run created', {
        ...nextMeta,
...
export function record(scope = {}, runId, event, payload = {}) {
...
export function finish(scope = {}, runId, finalState = {}) {
    if (!isEnabled() || !runId) return null;
    const global = (typeof window !== 'undefined') ? window : (typeof globalThis !== 'undefined' ? globalThis : {});
    const normalizedScope = normalizeScope(scope);
    const scopeKey = buildScopeKey(normalizedScope);
...
export function clearScope(scope = {}) {
    const global = (typeof window !== 'undefined') ? window : (typeof globalThis !== 'undefined' ? globalThis : {});
    const normalizedScope = normalizeScope(scope);
    removeKey(global, getRunsKey(buildScopeKey(normalizedScope)));
}

export { normalizeScope, buildScopeKey, buildSummary };
