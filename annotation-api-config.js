(function (global) {
    ...
    function getEditableConfig(source = null) {
    ...
    function syncWindowConfig(rawConfig) {
    ...
    function syncWindowConfigFromStore(store) {
        const currentProfile = getCurrentProfile(store);
        if (!currentProfile) {
            clearWindowConfig();
            return null;
